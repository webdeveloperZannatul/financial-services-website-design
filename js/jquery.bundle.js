    ...
    $.fn.parallaxie = function(options) {
        ...
        this.each(function() {
            ...
            if (typeof image_url == 'undefined') {
                ...
                $(window).scroll(function() { /* var pos_y = - ( $(window).scrollTop() - $el.offset().top ) * ( 1 + local_options.speed ) - ( $el.offset().top * local_options.speed ); */
                    var pos_y = local_options.offset + ($el.offset().top - $(window).scrollTop()) * (1 - local_options.speed);
                    $el.data('pos_y', pos_y);
...
/*! Filterizr is a jQuery plugin | Author - Yiotis Kaltsikis | Version 1.2.5 | License MIT License */
! function(t, i) {
    "use strict";
...
/*! Magnific Popup - v1.1.0 - 2016-02-20 | Copyright (c) 2016 Dmitry Semenov | License MIT License */
! function(a) {
...
! function(e) {
    e.fn.ColorPanel = function(a) {
        var n = e.extend({
            ...
            t = this;
        e("#cpToggle").click(function(a) {
            a.preventDefault(), e("ul", t).slideToggle()
        });
        var l = n.colors || null;
        l && (e.each(l, function(a, l) {
            var s = e("<li/>"),
                i = e("<a />", {
                    href: l,
                    "class": n.linkClass
                }).css("background-color", a);
            s.append(i), e(t).find("ul").append(s)
        }), e("ul", t).on("click", "a", function(a) {
            a.preventDefault();
            var t = e(this).attr("href") || "default.css";
            n.animateContainer ? e(n.animateContainer).fadeOut(function() {
                e(n.styleSheet).attr("href", t), e("html, body").animate({
                    scrollTop: 0
                }, 600), e(".site-header").removeClass("has-fixed"), e(this).delay(1e3).fadeIn()
            }) : e(n.styleSheet).attr("href", t)
        }))
    }
}(jQuery);